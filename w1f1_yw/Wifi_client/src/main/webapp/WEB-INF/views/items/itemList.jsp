...
<body>
   <div class="container">
	...
	<div class="col-4" id="searchList"></div>
	<br>
	
	<div class="col-4" id="itemList"></div>
	<br>
...
<script>
				...
				for(var i=0; i<data.itemList.length; i++){
					...
					var title = data.itemList[i].title;
	 				...
	 				MyItemTotalList.push(new MyItem(midx, iidx, oidx, pidx, title, price, count_m, count_w,
		    			...
		    			html+='		<p>Card</p>';
		    			html+='			<div class="card">';
		    			//html+='				<img src="'+photo+'" alt="" class="card-img-top" />';
    ...
    function showDetails(iidx){
    	location.href='itemView/iidx='+iidx;
    }
