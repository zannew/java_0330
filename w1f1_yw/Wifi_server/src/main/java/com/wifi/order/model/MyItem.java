...
public class MyItem {
	...
	public MyItem(int midx, int iidx, int oidx, int pidx, String title, int price, int count_m, int count_w,
			...
			int view_count, int category, int istate, int ostate, int pstate) {
		super();
		this.midx = midx;
		this.iidx = iidx;
		this.oidx = oidx;
	...
	public String toString() {
		return "MyItem [midx=" + midx + ", iidx=" + iidx + ", oidx=" + oidx + ", pidx=" + pidx + ", title=" + title
				...
				+ ", photo=" + photo + ", view_count=" + view_count + ", category=" + category + ", istate=" + istate
				+ ", ostate=" + ostate + ", pstate=" + pstate + "]";
	}
