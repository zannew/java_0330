...
select ename, substr(hiredate, 0, 2), substr(hiredate,4,2)
from emp
;
...
select trunc(sysdate-to_date('20200101', 'yyyy-mm-dd')) as pastDays
from dual
;

--21. 사원들의 상관 사번을 출력하되 상관이 없는 사원에 대해서는 NULL 값 대신 0으로 출력하시오.
select empno, ename,nvl(mgr,0) as mgrno
from emp
;
...
--31. 업무job를 표시한 다음, 
--해당 업무job에 대해 부서 번호별deptno 급여sal 및 부서 10, 20, 30의 급여 총액sum을 각각 출력하시오. 
